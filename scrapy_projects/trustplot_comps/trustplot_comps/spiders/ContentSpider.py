...
# ['contact_link', 'url', 'delivery_link', 'faq_link', 'privacy_link', 'return_link', 'terms_link', 'warranty_link']
field = 'faq_link'
...
data_base = pd.read_csv('/home/val/coding/scrapy_projects/trustpilot-merged.csv', encoding = 'unicode_escape')
#company_dict = {}
...
class BaseSpider(Spider):
    ...
    def parse(self, response):
        ...
        frame[field] = extract_text(response)
        print(frame)
